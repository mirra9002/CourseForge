...
export default function Allcoursessection({courses}){
  ...
  {courses.results.map(course => (
    ...
    // <div  onClick={() => navigate(`/courseinfo/${course.id}`)} class="cursor-pointer w-110 max-h-50 bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700">
      
    //     <div id="defaultTabContent">
    //         <div class=" bg-white rounded-lg md:p-8 hover:bg-gray-50 dark:bg-gray-800" id="about" role="tabpanel" aria-labelledby="about-tab">
    //             <h2 class="mb-2 text-2xl font-extrabold tracking-tight text-gray-900 dark:text-white">{course.title}</h2>
    //             <p class="mb-2 text-sm text-gray-500 dark:text-gray-400">{course.description}</p>
