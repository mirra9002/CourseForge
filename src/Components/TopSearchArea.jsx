...
export default function Topsearcharea({courses}){
    ...
    return(<>
    <section class="bg-[#0b1d3a] dark:bg-gray-950 text-white py-24 px-4 text-center">
        ...
        <form class="max-w-md mx-auto pb-32" onSubmit={handleSubmit}>
            ...
            <input
                ...
                class="w-full p-4 pe-16 text-sm text-[#0b1d3a] dark:text-white dark:bg-gray-800 rounded-full"
                required
            />
            <button
                type="submit"
                class="cursor-pointer absolute end-2.5 bottom-2.5 text-white bg-blue-700 hover:bg-blue-800 dark:bg-blue-600 dark:hover:bg-blue-700 font-medium rounded-full text-sm px-4 py-2"
            >
                Пошук
            </button>
            </div>
