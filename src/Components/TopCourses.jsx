...
<br/>
    ...
    <div class="relative flex items-center justify-center mt-10">
        ...
        <button type="button"
            class="ml-25 absolute left-0 z-10 bg-[#0b1d3a]  hover:bg-[#0b1d3a]  text-white font-medium rounded-full p-3 shadow-md focus:outline-none focus:ring-2 focus:ring-blue-500">
        ...
        <div class="flex flex-wrap justify-center gap-6">
            ...
            <h5 class="mb-2 text-2xl font-bold tracking-tight text-[#0b1d3a]">JavaScripts for beginners</h5>  
            <p class="font-normal text-[#0b1d3a]">Learn basics from scratch</p>
            ...
            <a href="#"
            class="block max-w-sm p-16 bg-white border border-gray-200 rounded-lg shadow-sm hover:bg-gray-100 transition-colors duration-300">
            <h5 class="mb-2 text-2xl font-bold tracking-tight text-[#0b1d3a]">Python advanced course</h5>
            <p class="font-normal text-bl[#0b1d3a]ack">For advanced coders</p>
