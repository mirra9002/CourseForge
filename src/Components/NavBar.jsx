...
export default function Navbar() {
    ...
    <nav class="bg-white dark:bg-gray-900 fixed w-full z-20 top-0 start-0 border-b border-gray-200 dark:border-gray-600">
        ...
        {status === 'authed' ? 
            <div class="ml-22 flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
                <div onClick={() => havigateToPage('/auth/1')} class="cursor-pointer relative inline-flex items-center justify-center w-10 h-10 overflow-hidden bg-gray-100 hover:bg-gray-200 rounded-full dark:bg-gray-600">
                    <span class="font-medium text-gray-600 dark:text-gray-300">{userInitials ? userInitials : null}</span>
                </div>
            </div>
             : 
