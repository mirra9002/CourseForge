export function TextSkeleton(){
  ...
  <div className="mt-5 mb-5 ml-5">
    ...
    <div class="h-2 bg-gray-200 rounded-full dark:bg-gray-700 max-w-[530px] mb-2.5"></div>
    <div class="h-2 bg-gray-200 rounded-full dark:bg-gray-700 max-w-[530px] mb-2.5"></div>
    ...
    <div class="h-2 bg-gray-200 rounded-full dark:bg-gray-700 max-w-[530px] mb-2.5"></div>
    <div class="h-2 bg-gray-200 rounded-full dark:bg-gray-700 max-w-[500px] mb-2.5"></div>
    <div class="h-2 bg-gray-200 rounded-full dark:bg-gray-700 max-w-[560px]"></div>
...
export function ImageSkeleton() {
  ...
  <div role="status" class="space-y-8 animate-pulse md:space-y-0 md:space-x-8 rtl:space-x-reverse md:flex md:items-center">
    <div class="flex items-center justify-center w-full h-64 bg-gray-300 rounded-sm sm:w-96 dark:bg-gray-700">
