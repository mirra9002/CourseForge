...
export default function Footer(){
    return(<>
     <footer class="bg-white rounded-lg shadow-sm mt-4 ml-4 mr-4 mb-2 dark:bg-gray-800">
        ...
        <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">{new Date().getFullYear()} | <a href="#" class="hover:underline">Розробка інтерактивної платформи для навчання інформаційним технологіям CourseForge</a>
        </span>
        <ul class="flex flex-wrap items-center mt-3 text-sm font-medium text-gray-500 dark:text-gray-400 sm:mt-0">
            ...
            <li>
                <Link to="/documentation" class="hover:underline me-4 md:me-6">Документація</Link>
            </li>
        </ul>
        </div>
    </footer></>)
