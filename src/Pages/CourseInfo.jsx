...
export default function Courseinfo() {
    ...
    <div className='mt-20 ml-25 mr-25'>   
        <h2 className="text-5xl mb-10 font-bold dark:text-white">JavaScript для початківців</h2>
        ...
        <h5 class="mb-10 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Розділи курсу</h5>
            ...
            <ol class=" ml-2 relative border-s border-gray-200 dark:border-gray-700 ">                  
                ...
                <li class="mb-10 ms-6  hover:bg-gray-100">            
                    ...
                    <h3 class="flex items-center mb-1 text-lg font-semibold text-gray-900 dark:text-white">Основи: змінні, data types, оператори та функції </h3>
                    <p class="mb-4 text-base font-normal text-gray-500 dark:text-gray-400">Які бувають типи даних? Що таке змінна, оператор та функція</p>
