...
function MyCourseCard(data) {
  ...
  <div class="max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow-sm">
      ...
      <button onClick={() => navigate(`/courseinfo/${course.id}`)} type="button" class=" text-blue-700 hover:text-white border border-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2">Перейти до курсу</button>
